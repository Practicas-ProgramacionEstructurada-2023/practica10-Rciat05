    ...
    internal class Program
    {
         static void Main(string[] args)
        {
            int opcion;
                ...
                {
                    Console.WriteLine("\n.::Menu de opciones::.");
                    Console.WriteLine("1. Cálculo de factoriales de un número.");
                    ...
                    if (int.TryParse(Console.ReadLine(), out opcion))
                    {
                        switch (opcion)
                        {
                            case 1: 
                                ...
                                Console.WriteLine($"El factor de {num} es {resultado}");
                                break;
                            ...
                            case 5:
                                int[] numeross = {10, 20, 30, 40, 50}; //Inicializacion de un arreglo de enteros
